...
std::vector<AircraftData> initializeAircraftData()
{
    ...
    data[Aircraft::Avenger].directions.push_back(Direction(+45.f, 50));
    data[Aircraft::Avenger].directions.push_back(Direction(  0.f, 50));
    data[Aircraft::Avenger].directions.push_back(Direction(-45.f, 100));
    data[Aircraft::Avenger].directions.push_back(Direction(  0.f, 50));
    data[Aircraft::Avenger].directions.push_back(Direction(+45.f, 50));	
