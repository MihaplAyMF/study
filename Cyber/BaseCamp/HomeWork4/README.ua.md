...
Я вписав команду gpg --list-key з надією вивести gpg ключі з .sources файлів, вона створила локальну папку .gnupg з файлами pubring.kbx та trustdb.gpg. 
...
Також щоб переконатися що ключ коректний можна використати команду sudo apt update 
